# script to read 'bucket_amount_goal_{xx}}_pos_goal_{xx}}_waterline_{xx}}_seed_0_error_*.pkl' files
#
# Z.Zhang
# 2023/2
...
# fileName = '/scaled_bucket_targeted_amount_'+str(amount_goal)+'_saved_trajs.pkl' # unit: mm
...
fileName = '/bucket_amount_goal_'+str(amount_goal)+'_pos_goal_'+str(pos_goal)+'_waterline_'+str(waterline)+'_seed_0_error_*.pkl' # unit:
